...
/***/ "./node_modules/compress.js/src/core/base64.js":
/*!*****************************************************!*\
  !*** ./node_modules/compress.js/src/core/base64.js ***!
  \*****************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({ size, mime, data, prefix });


/***/ }),

/***/ "./node_modules/compress.js/src/core/converter.js":
/*!********************************************************!*\
  !*** ./node_modules/compress.js/src/core/converter.js ***!
  \********************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = ({ base64ToFile, imageToCanvas, canvasToBase64, size });


/***/ }),

/***/ "./node_modules/compress.js/src/core/file.js":
/*!***************************************************!*\
  !*** ./node_modules/compress.js/src/core/file.js ***!
  \***************************************************/
/*! exports provided: default */
...
/***/ "./node_modules/compress.js/src/core/image.js":
/*!****************************************************!*\
  !*** ./node_modules/compress.js/src/core/image.js ***!
  \****************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = ({ load, resize });


/***/ }),

/***/ "./node_modules/compress.js/src/core/photo.js":
/*!****************************************************!*\
  !*** ./node_modules/compress.js/src/core/photo.js ***!
  \****************************************************/
/*! exports provided: default */
...
/***/ "./node_modules/compress.js/src/core/rotate.js":
/*!*****************************************************!*\
  !*** ./node_modules/compress.js/src/core/rotate.js ***!
  \*****************************************************/
/*! exports provided: default */
...
/***/ "./node_modules/compress.js/src/index.js":
/*!***********************************************!*\
  !*** ./node_modules/compress.js/src/index.js ***!
  \***********************************************/
/*! exports provided: default */
...
/* harmony import */ var _core_base64_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./core/base64.js */ "./node_modules/compress.js/src/core/base64.js");
/* harmony import */ var _core_converter_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./core/converter.js */ "./node_modules/compress.js/src/core/converter.js");
/* harmony import */ var _core_file_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./core/file.js */ "./node_modules/compress.js/src/core/file.js");
/* harmony import */ var _core_image_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./core/image.js */ "./node_modules/compress.js/src/core/image.js");
/* harmony import */ var _core_photo_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./core/photo.js */ "./node_modules/compress.js/src/core/photo.js");
/* harmony import */ var _core_rotate_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./core/rotate.js */ "./node_modules/compress.js/src/core/rotate.js");
...
class Compress {
  ...
  static convertBase64ToFile(base64, mime) {
    return _core_converter_js__WEBPACK_IMPORTED_MODULE_2__["default"].base64ToFile(base64, mime);
  }
}
...
function loopCompression(
  ...
  const base64str = _core_converter_js__WEBPACK_IMPORTED_MODULE_2__["default"].canvasToBase64(canvas, quality);
  const newSize = _core_base64_js__WEBPACK_IMPORTED_MODULE_1__["default"].size(base64str);
...
async function compressFile(file, options) {
  ...
  const photo = new _core_photo_js__WEBPACK_IMPORTED_MODULE_5__["default"](options);
  photo.start = window.performance.now();
  photo.alt = file.name;
  photo.ext = file.type;
  photo.startSize = file.size;
  photo.orientation = photo.rotate ? await _core_rotate_js__WEBPACK_IMPORTED_MODULE_6__["default"].orientation(file) : 0;

  return compressImage(photo)(await _core_file_js__WEBPACK_IMPORTED_MODULE_3__["default"].load(file));
}

function compressImage(photo) {
  return async (src) => {
    const img = await _core_image_js__WEBPACK_IMPORTED_MODULE_4__["default"].load(src);
    ...
    // Resize the image
    if (photo.resize) {
      const { width, height } = _core_image_js__WEBPACK_IMPORTED_MODULE_4__["default"].resize(photo.maxWidth, photo.maxHeight)(
        img.naturalWidth,
        img.naturalHeight
      );
    ...
    const canvas = _core_converter_js__WEBPACK_IMPORTED_MODULE_2__["default"].imageToCanvas(
      photo.endWidth,
      photo.endHeight,
      photo.orientation
    )(img);
    ...
    photo.iterations = 1;
    photo.base64prefix = _core_base64_js__WEBPACK_IMPORTED_MODULE_1__["default"].prefix(photo.ext);
    ...
    photo.finalSize = _core_base64_js__WEBPACK_IMPORTED_MODULE_1__["default"].size(base64);
    photo.end = window.performance.now();
    const difference = photo.end - photo.start; // in ms

    return {
      data: _core_base64_js__WEBPACK_IMPORTED_MODULE_1__["default"].data(base64),
      prefix: photo.base64prefix,
      elapsedTimeInSeconds: difference / 1000, // in seconds
      alt: photo.alt,
      initialSizeInMb: _core_converter_js__WEBPACK_IMPORTED_MODULE_2__["default"].size(photo.startSize).MB,
      endSizeInMb: _core_converter_js__WEBPACK_IMPORTED_MODULE_2__["default"].size(photo.finalSize).MB,
      ext: photo.ext,
